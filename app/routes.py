...
Routes are attached directly to the Flask app via init_routes(app) so that
url_for() endpoint names stay unqualified (e.g. 'logout', 'index') and
...
def init_routes(app: Flask) -> None:
    """Register all routes directly on the Flask app instance."""
